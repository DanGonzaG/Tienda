...
public class ReporteController {
    ...
    public ResponseEntity<Resource> reporteVentasTotales(@RequestParam String fechaIni,@RequestParam String fechaFin, @RequestParam String tipo) throws IOException{
     ...
     @GetMapping("/VentasXCategoria")
    public ResponseEntity<Resource> reporteVentasXCategoria(@RequestParam String categorias,@RequestParam String tipo) throws IOException{
        Map<String, Object> parametros = new HashMap();
        parametros.put("categorias", categorias);        
        return reporteService.generaReporte("VentasXCategoria", parametros, tipo);
