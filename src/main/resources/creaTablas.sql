/*solo se agrega este archivo para tener un respaldo de la base de datos pero no es necesario*/
/*Se crea la base de datos */
drop schema if exists techshop; /*Borra la base de datos*/
drop user if exists usuario_prueba; /*borra un usuario*/
CREATE SCHEMA techshop ; /*Crea el esquema de la base datos*/

/*Se crea un usuario para la base de datos llamado "usuario_prueba" y tiene la contraseña "Usuario_Clave."*/
create user 'usuario_prueba'@'%' identified by 'Usuar1o_Clave.'; /*crea un usuario y una contraseña*/

/*Se asignan los prvilegios sobr ela base de datos TechShop al usuario creado */
grant all privileges on techshop.* to 'usuario_prueba'@'%';
flush privileges;/*salva la informacion*/

/* la tabla de categoria contiene categorias de productos*/
create table techshop.categoria ( /*se crea un tabla con atributos*/
  id_categoria INT NOT NULL AUTO_INCREMENT, /*id_categoria es un atributo, int = entero, not null = que no puede estar vacio, 
  auto_increment = se llena automaticamente*/
  descripcion VARCHAR(30) NOT NULL, /*Varchar = tipo caractar de tamaño 30 */
  ruta_imagen varchar(1024), /*es para definir un ruta*/ 
  activo bool, /*tipo booleano para saber si la categoria esta activo o no*/
  PRIMARY KEY (id_categoria)) /*se define la llave primaria*/
ENGINE = InnoDB
